         ...
         <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class="active">
                     <a href="#Meating" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span class="ripple rippleEffect"></span><i class="ion ion-ios-people"></i><span>Meating</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <ul id="Meating" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        <li><a href="meating-dashboard.html"><i class="las la-house-damage"></i>Dashboard</a></li>
                        <li class="active"><a href="meating-form.php"><i class="ri-function-line"></i>FORM</a></li>                 
                     </ul>
                  </li>
                  <li>
                  ...
                  <div class="tab-pane fade active show" id="personal-information" role="tabpanel">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <form action="action-meating.php" method="POST"  >
                              ...
                              <div class="form-group col-sm-3">
                                 ...
                                 <div class="form-group col-sm-3">
                                    <label>Meating Request By:</label>
                                    <select id="building" class="form-control" id="" name="meatingby">
                                    <option value=""></option>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select class="form-control" id="" name="status">
                                       ...
                                       <option value="Not Attendant ">Not Attendant</option>
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Meating  Data</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                                ...
                                <tr>
                                       <tbody>
                                          ...
                                          // Create connection
                                            ...
                                            <a class='badge iq-bg-info' data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit' href='meating-form.php'><i class='ri-pencil-line'></i></a>
