               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class="active">
                     ...
                     <ul id="TICKET" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        <li><a href="ticket-dashboard.php"><i class="las la-house-damage"></i>Dashboard</a></li>
                        <li class="active"><a href="ticket-data.php"><i class="ri-function-line"></i>FORM</a></li>
                     ...
                     <ul id="pages" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li>
                           ...
                           <ul id="authentication" class="iq-submenu collapse" data-parent="#pages">
                              <li><a href=".\Sign in\index.html"><i class="las la-sign-in-alt"></i>Login</a></li>
                              <li><a href=".\Sign in\index.html"><i class="ri-login-circle-line"></i>Register</a></li>
               ...
               <div class="tab-content">
                  <div class="tab-pane fade active show" id="personal-information" role="tabpanel">
                     <div class="iq-card">
                        ...
                        <form action="ticket-database.php" method="POST"  >
                        <form action="update.php" method="POST">  
                              ...
                              <div class=" row align-items-center">
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1"  class="custom-select" name="campus" >
                                       <option value=""></option>
                                 ...
                                 <div class="form-group col-sm-3">   
                                    ...
                                    <select class="form-control" id="main_menu" class="custom-select" name="institute">
                                       <option value=""></option>
                                       <option value="BOYS">Boys Hostel</option>
                                       <option value="CAO">CAO - Central Administrative Office</option>
                                       <option value="CDL">CDL - Centre for Distance Learning</option>
                                       <option value="DENTAL">DENTAL - GITAM Dental College & Hospital</option>
                                       <option value="GIIB">GIIB - GITAM School of International Business</option>
                                       <option value="GIM">GIM - GITAM Institute of Management</option>
                                       <option value="GIMS">GIMS - GITAM Institute of Medical Sciences</option>
                                       <option value="GIMSRC">GIMSRC - GIMSR College</option>
                                       <option value="GIMSRH">GIMSRH - GIMSR Hospital</option>
                                       <option value="GIN">GIN - GITAM Institute of Nursing</option>
                                       <option value="GIP">GIP - GITAM Institute of Pharmacy</option>
                                       <option value="GIRLS">GIRLS HOSTEL - Girls Hostel</option>
                                       <option value="GIS">GIS - GITAM Institute of Science</option>
                                       <option value="GIT">GIT - GITAM Institute of Technology</option>
                                       <option value="GSA">GSA - GITAM School of Architecture</option>
                                       <option value="GSGS">GSGS - GITAM School of Gandhian Studies</option>
                                       <option value="GSL">GSL - GITAM School of Law</option>
                                       <option value="PTY">PTY - GITAM School of Physiotherapy</option>
                                       <option value="SA">SA - Student Activites</option>
                                       <option value="SWS">SWS - Swechha Waldorf School</option>
                                       </select>
                                 </div>

                                 <div class="form-group col-sm-3">   
                                    <label for="">Department:</label>
                                    <select class="form-control" name="department" id="sub_menu" class="custom-select" >
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <input type="text" class="form-control" id="fname" name="building" value="">                                  
                                    </select>
                                 </div>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect3" name="category">
                                       <option value=""></option>
                                       <option>CPU</option>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect3"  name="technicalassociate" >
                                       <option value=""></option>
                                       <option>GUNA</option>
                                       <option>SATISH</option>
                                       <option>SANTOSH</option>
                                       <option>GIRISH</option>
                                       <option>KISHORE</option>
                                       <option>PHANI SHEKAR</option>
                                       <option>REVANTH</option>
                                       <option>PURUSHOTHAM</option>
                                       <option>VAMSHI</option>
                                       <option>PHANI KUMAR</option>
                                       <option>SATISH BABU</option>                                      
                                    </select>
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label>Status :</label>
                                    <select class="form-control" id="exampleFormControlSelect3" name="status">
                                       <option value=""></option>
                                       <option>CLOSED</option>
                                       <option>SCRAP</option>
                                       <option>CATS STORE</option>                                     
                                    </select>
                                 </div>
                              ...
                              <div class="row justify-content-between">
                                 ...
                                 <div class="col-sm-12 col-md-6">
                                    <div class="user-list-files d-flex float-right">
                                      <!-- <a class="iq-bg-primary" type="submit" onclick="window.print();" >
                                          Print 
                                        </a>-->
                                        <form method="post" onclick="window.print();">
                                        <input type="submit" name="print" class="btn bg-primary" value="Print" />
                                        </form> &nbsp;
                                        <form method="post" action="export.php">
                                        <input type="submit" name="export" class="btn bg-danger" value="Excel" />
                                        </form> &nbsp;
                                        <form method="post" onclick="window.print();">
                                        <input type="submit" name="print" class="btn bg-success" value="Pdf" />
                                        </form>
                                      </div>
                                 </div>
                              </div>
                                ...
                                <tr>
                                       ...
                                       <button type="submit" name="updatedata" class="btn btn-primary">Update Data</button>
                                          ...
                                          // Create connection
                                             ...
                                             <a class='badge iq-bg-primary' data-toggle='tooltip' data-placement='top' title='' data-original-title='View' href='ticket-data.php'><i class='las la-eye'></i></a>
                                            <a class='badge iq-bg-info' data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit' href='ticket-data.php'><i class='ri-pencil-line'></i></a>
