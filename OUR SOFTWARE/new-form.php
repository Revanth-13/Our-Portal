               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     ...
                     <ul id="Meating" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="meating-form.html"><i class="ri-function-line"></i>FORM</a></li>
                  ...
                  <li class="active">
                        ...
                        <ul id="Log-Book" class="iq-submenu collapse  show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="new-form.php"><i class="ri-function-line"></i>New Asset FORM</a></li>
                        ...
                        <div class="iq-card-body">
                           <form action="action.php" method="POST" >
                              ...
                              <div class=" row align-items-center">
                                 ...
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Receiver Employee ID:</label>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select class="form-control" id="" name="status">
                                       <option value=""></option>
                                       <option value="In Cats Store">In Cats Store</option>
                                 ...
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Invoice Upload:</label>
                                    <input type="text" class="form-control" id="fname" name="configuration" value="">
                                 </div>
                                 
                                 
                                 <div class="form-group col-sm-6">
                                    <label for="fname">CPU Serial No:</label>
                                    <input type="text" class="form-control" id="fname" name="quantity" value="">
                                 </div>
                                 <div class="form-group col-sm-5">
                                    <label for="fname">Monitor Serial No:</label>
                                    <input type="text" class="form-control" id="fname" name="quantity" value="">
                                 </div>

                                 <a class='badge iq-bg-primary' data-toggle='tooltip' data-placement='top' title='' data-original-title='ADD'  href=''><i class='las la-plus'>              </i></a>
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">New Asset Data</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
