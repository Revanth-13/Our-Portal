         ...
         <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class="active">
                        <a href="#Log-Book" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span class="ripple rippleEffect"></span><i class="las la-address-book"></i><span>Log-Book</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="Log-Book" class="iq-submenu collapse  show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="standby-form.php"><i class="ri-function-line"></i>Stand-By FORM</a></li>
                        ...
                        <div class="iq-card-body">
                           <form action="action.php" method="POST" >
                              ...
                              <div class=" row align-items-center">
                                 ...
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Asset Serial No:</label>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select class="form-control" id="" name="status">
                                       <option value=""></option>
                                       <option value="In Cats Store">Cats Store</option>
                                       <option value="Delivered">Stand By</option>
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Old Asset Data</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
