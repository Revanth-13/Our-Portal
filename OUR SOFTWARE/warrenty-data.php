         ...
         <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     <a href="#TICKET" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="ri-coupon-line"></i><span>Ticket</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <ul id="TICKET" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="ticket-dashboard.html"><i class="las la-house-damage"></i>Dashboard</a></li>
                        <li><a href="ticket-data.php"><i class="ri-function-line"></i>FORM</a></li>
                       
                  
                     </ul>
                  </li>
                  <li class="active">
                     <a href="#Warrenty" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span class="ripple rippleEffect"></span><i class="ri-file-shield-2-line"></i><span>Warrenty</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <ul id="Warrenty" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        <li><a href="warrenty-dashboard.html"><i class="las la-house-damage"></i>Dashboard</a></li>
                        <li class="active"><a href="warrenty-data.php"><i class="ri-function-line"></i>FORM</a></li>
                  ...
                  <li>
                     ...
                     <ul id="Meating" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="meating-dashboard.html"><i class="las la-house-damage"></i>Dashboard</a></li>
                        ...
                        <div class="iq-card-body">
                           <form action="action.php" method="POST" >
                              ...
                              <div class=" row align-items-center">
                                 ...
                                 <div class="form-group col-sm-3">
                                    <label>Campus</label>
                                    <select id="campus"class="form-control" id="" name="campus">
                                       <option value=""></option>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select id="institute" class="form-control" id="" name="institute">
                                       <option value=""></option>
                                       <option  value="BOYS HOSTEL - Boys Hostel">BOYS HOSTEL - Boys Hostel</option>
                                       <option  value="CAO - Central Administrative Office">CAO - Central Administrative Office</option>
                                       <option  value="CDL - Centre for Distance Learning">CDL - Centre for Distance Learning</option>
                                       <option  value="DENTAL - GITAM Dental College & Hospital">DENTAL - GITAM Dental College & Hospital</option>
                                       <option  value="GIIB - GITAM School of International Business">GIIB - GITAM School of International Business</option>
                                       <option  value="GIM - GITAM Institute of Management">GIM - GITAM Institute of Management</option>
                                       <option  value="GIMS - GITAM Institute of Medical Sciences">GIMS - GITAM Institute of Medical Sciences</option>
                                       <option  value="GIMSRC - GIMSR College">GIMSRC - GIMSR College</option>
                                       <option  value="GIMSRH - GIMSR Hospital">GIMSRH - GIMSR Hospital</option>
                                       <option  value="GIN - GITAM Institute of Nursing">GIN - GITAM Institute of Nursing</option>
                                       <option  value="GIP - GITAM Institute of Pharmacy">GIP - GITAM Institute of Pharmacy</option>
                                       <option  value="GIRLS HOSTEL - Girls Hostel">GIRLS HOSTEL - Girls Hostel</option>
                                       <option  value="GIS - GITAM Institute of Science">GIS - GITAM Institute of Science</option>
                                       <option  value="GIT - GITAM Institute of Technology">GIT - GITAM Institute of Technology</option>
                                       <option  value="GSA - GITAM School of Architecture">GSA - GITAM School of Architecture</option>
                                       <option  value="GSGS - GITAM School of Gandhian Studies">GSGS - GITAM School of Gandhian Studies</option>
                                       <option  value="GSL - GITAM School of Law">GSL - GITAM School of Law</option>
                                       <option  value="PTY - GITAM School of Physiotherapy">PTY - GITAM School of Physiotherapy</option>
                                       <option  value="SA - Student Activites">SA - Student Activites</option>
                                       <option  value="SWS - Swechha Waldorf School">SWS - Swechha Waldorf School</option>
                                    </select>
                                 </div>
                                 
                                 <div class="form-group col-sm-3">
                                    <label>Department:</label>
                                    <select id="department" class="form-control" id="" name="department">
                                       <option value=""></option>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <select id="building" class="form-control" id="" name="building">
                                       <option value=""></option>
                                 ...
                                 <div class="form-group col-sm-3">
                                    ...
                                    <input type="text" class="form-control" id="fname" name="employeeid" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Name:</label>
                                    <input type="text" class="form-control" id="fname" name="name" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">G-Indent No:</label>
                                    <input type="text" class="form-control" id="fname" name="gindentno" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Ticket No:</label>
                                    <input type="text" class="form-control" id="fname" name="ticketno" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label>Catrgory :</label>
                                    <select id="category" class="form-control" id="" name="category">
                                       <option value=""></option>
                                 ...
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Asset Claimed Part:</label>
                                    <input type="text" class="form-control" id="fname"name="assetclaimed" value="">
                                 </div>
                                 
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Make:</label>
                                    <input type="text" class="form-control" id="fname" name="make" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Model:</label>
                                    <input type="text" class="form-control" id="fname" name="model" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Asset Serial No Old:</label>
                                    <input type="text" class="form-control" id="fname"  name="assetserialno" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Asset Serial No New:</label>
                                    <input type="text" class="form-control" id="fname" name="quantity" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Configuration:</label>
                                    <input type="text" class="form-control" id="fname" name="configuration" value="">
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label for="fname">Warrenty ID:</label>
                                    <input type="text" class="form-control" id="fname" name="warrentyid" value="">
                                 </div>
                                 
                                 <div class="form-group col-sm-3">
                                    
                                    <label for="exampleInputdate">Resolved Date</label>
                                    <input type="date" class="form-control" id="exampleInputdate" name="resolveddate" name="date">
                                 </div>

                                 <div class="form-group col-sm-3">
                                    <label>Technical Associate :</label>
                                    <select id="technicalassociate" class="form-control" id="floor" name="technicalassociate" >
                                       <option value=""></option>
                                       ...
                                       <option value="PHANI SHEKAR">PHANI SHEKAR</option>
                                       <option value="REVANTH">REVANTH</option>
                                       <option value="PURUSHOTHAM">PURUSHOTHAM</option>
                                       <option value="VAMSHI">VAMSHI</option>
                                       <option value=">PHANI KUMAR">PHANI KUMAR</option>
                                       <option value="SATISH BABU">SATISH BABU</option>                                      
                                    </select>
                                 </div>
                                 <div class="form-group col-sm-3">
                                    <label>Status :</label>
                                    <select class="form-control" id="" name="status">
                                       ...
                                       <option value="SCRAP">Close</option>
                                                                         
                                    </select>
                                 </div>
                                 <div class="form-group col-sm-12">
                                    <label>Notes:</label>
                                    <textarea class="form-control" name="notes" rows="5" style="line-height: 22px;">
                                    </textarea>
                                 </div>
                              </div>
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Warrenty Data</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                                    ...
                                    <tr>
                                       <tbody>
                                          ...
                                          // Create connection
                                             ...
                                             <td>" . $row ["category"] . "</td>
                                             <td>" . $row ["model"] . "</td>
                                             <td>" . $row ["warrentyid"] . "</td>                                                                  
                                                                     
                                             <td>		
                                             <a class='badge iq-bg-success ' <td>" . $row ["status"] . "</td>  </a>
                                           
                                             <td>		
												
                                             <a class='d-flex align-items-center list-user-action'</a>
                                             <a class='badge iq-bg-primary' data-toggle='tooltip' data-placement='top' title='' data-original-title='View' href='warrenty-data.php'><i class='las la-eye'></i></a>
                                            <a class='badge iq-bg-info' data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit' href='warrenty-data.php'><i class='ri-pencil-line'></i></a>
                                            <a class='badge iq-bg-primary' data-toggle='tooltip' data-placement='top' title='' data-original-title='Delete'><i class='ri-delete-bin-line'></i></a>
								          </td>
